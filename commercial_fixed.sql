...
INSERT INTO CUSTOMERS VALUES ( 'ANATR','Ana Trujillo Emparedados y helados','Avda. de la Constitucin 2222','Mxico D.F.','05021','Mexique','(5) 555-4729','(5) 555-3745' );

INSERT INTO CUSTOMERS VALUES ( 'ANTON','Antonio Moreno Taquera','Mataderos  2312','Mxico D.F.','05023','Mexique','(5) 555-3932','' );

INSERT INTO CUSTOMERS VALUES ( 'AROUT','Around the Horn','120 Hanover Sq.','London','WA1 4SD','Royaume-Uni','(71) 555-7788','(71) 555-6750' );

INSERT INTO CUSTOMERS VALUES ( 'BERGS','Berglunds snabbkp','Berguvsvgen  8','Lule','S-958 22','Sude','0921-12 34 65','0921-12 34 67' );

INSERT INTO CUSTOMERS VALUES ('BLAUS','BlauerSeeDelikatessen','Forsterstr. 57','Mannheim','68306','Allemagne','0621-08460','0621-08924' );

INSERT INTO CUSTOMERS VALUES ( 'BLONP','Blondel pre et fils','24, place Klber','Strasbourg','67000','France','03.88.60.15.31','03.88.60.15.32' );

INSERT INTO CUSTOMERS VALUES ( 'BOLID','Blido Comidas preparadas','Araquil, 67','Madrid','28023','Espagne','(91) 555 22 82','(91) 555 91 99' );
...
INSERT INTO CUSTOMERS VALUES ( 'CENTC','Centro comercial Moctezuma','Sierras de Granada 9993','Mxico D.F.','05022','Mexique','(5) 555-3392','(5) 555-7293' );

INSERT INTO CUSTOMERS VALUES ( 'CHOPS','Chop-suey Chinese','Hauptstr. 29','Bern','3012','Suisse','0452-076545','' );

INSERT INTO CUSTOMERS VALUES ( 'COMMI','Comrcio Mineiro','Av. dos Lusadas, 23','So Paulo','05432-043','Brsil','(11) 555-7647','' );
...
INSERT INTO CUSTOMERS VALUES ( 'FAMIA','Familia Arquibaldo','Rua Ors, 92','So Paulo','05442-030','Brsil','(11) 555-9857','' );
...
INSERT INTO CUSTOMERS VALUES ( 'FOLIG','Folies gourmandes','184, chausse de Tournai','Lille','59000','France','03.20.16.10.16','03.20.16.10.17' );

INSERT INTO CUSTOMERS VALUES ( 'FOLKO','Folk och f HB','kergatan 24','Brcke','S-844 67','Sude','0695-34 67 21','' );

INSERT INTO CUSTOMERS VALUES ( 'FRANK','Frankenversand','Berliner Platz 43','Mnchen','80805','Allemagne','089-0877310','089-0877451' );
...
INSERT INTO CUSTOMERS VALUES ( 'GALED','Galera del gastrnomo','Rambla de Catalua, 23','Barcelona','08022','Espagne','(93) 203 4560','(93) 203 4561' );

INSERT INTO CUSTOMERS VALUES ( 'GODOS','Godos Cocina Tpica','Romero, 33','Sevilla','41101','Espagne','(95) 555 82 82','' );

INSERT INTO CUSTOMERS VALUES ( 'GOURL','Gourmet Lanchonetes','Av. Brasil, 442','Campinas','04876-786','Brsil','(11) 555-9482','' );
...
INSERT INTO CUSTOMERS VALUES ( 'HANAR','Hanari Carnes','Rua do Pao, 67','Rio de Janeiro','05454-876','Brsil','(21) 555-0091','(21) 555-8765' );

INSERT INTO CUSTOMERS VALUES ( 'HILAA','HILARIN-Abastos','Carrera 22 con Ave. Carlos Soublette #8-35','San Cristbal','5022','Venezuela','(5) 555-1340','(5) 555-1948' );
...
INSERT INTO CUSTOMERS VALUES ( 'KOENE','Kniglich Essen','Maubelstr. 90','Brandenburg','14776','Allemagne','0555-09876','' );
...
INSERT INTO CUSTOMERS VALUES ( 'LILAS','LILA-Supermercado','Carrera 52 con Ave. Bolvar #65-98 Llano Largo','Barquisimeto','3508','Venezuela','(9) 331-6954','(9) 331-7256' );
...
INSERT INTO CUSTOMERS VALUES ( 'MEREP','Mre Paillarde','43 rue St. Laurent','Montral','H1J 1C3','Canada','(514) 555-8054','(514) 555-8055' );
...
INSERT INTO CUSTOMERS VALUES ( 'OCEAN','Ocano Atlntico Ltda.','Ing. Gustavo Moncada 8585Piso 20-A','Buenos Aires','1010','Argentine','(1) 135-5333','(1) 135-5535' );
...
INSERT INTO CUSTOMERS VALUES ( 'OTTIK','Ottilies Kseladen','Mehrheimerstr. 369','Kln','50739','Allemagne','0221-0644327','0221-0765721' );

INSERT INTO CUSTOMERS VALUES ( 'PARIS','Paris spcialits','265, boulevard Charonne','Paris','75012','France','01.42.34.22.66','01.42.34.22.77' );

INSERT INTO CUSTOMERS VALUES ( 'PERIC','Pericles Comidas clsicas','Calle Dr. Jorge Cash 321','Mxico D.F.','05033','Mexique','(5) 552-3745','(5) 545-3745' );

INSERT INTO CUSTOMERS VALUES ( 'PICCO','Piccolo und mehr','Geislweg 14','Salzburg','5020','Autriche','6562-9722','6562-9723' );

INSERT INTO CUSTOMERS VALUES ( 'PRINI','Princesa Isabel Vinhos','Estrada da sade n. 58','Lisboa','1756','Portugal','(1) 356-5634','' );

INSERT INTO CUSTOMERS VALUES ( 'QUEDE','Que Delcia','Rua da Panificadora, 12','Rio de Janeiro','02389-673','Brsil','(21) 555-4252','(21) 555-4545' );

INSERT INTO CUSTOMERS VALUES ( 'QUEEN','Queen Cozinha','Alameda dos Canrios, 891','So Paulo','05487-020','Brsil','(11) 555-1189','' );

INSERT INTO CUSTOMERS VALUES ( 'QUICK','QUICK-Stop','Taucherstrae 10','Cunewalde','01307','Allemagne','0372-035188','' );
...
INSERT INTO CUSTOMERS VALUES ( 'RICAR','Ricardo Adocicados','Av. Copacabana, 267','Rio de Janeiro','02389-890','Brsil','(21) 555-3412','' );

INSERT INTO CUSTOMERS VALUES ( 'RICSU','Richter Supermarkt','Grenzacherweg 237','Genve','1203','Suisse','0897-034214','' );

INSERT INTO CUSTOMERS VALUES ( 'ROMEY','Romero y tomillo','Gran Va, 1','Madrid','28001','Espagne','(91) 745 6200','(91) 745 6210' );

INSERT INTO CUSTOMERS VALUES ( 'SANTG','Sant Gourmet','Erling Skakkes gate 78','Stavern','4110','Norvge','07-98 92 35','07-98 92 47' );
...
INSERT INTO CUSTOMERS VALUES ( 'SIMOB','Simons bistro','Vinbltet 34','Kbenhavn','1734','Danemark','31 12 34 56','31 13 35 57' );

INSERT INTO CUSTOMERS VALUES ( 'SPECD','Spcialits du monde','25, rue Lauriston','Paris','75016','France','01.47.55.60.10','01.47.55.60.20' );

INSERT INTO CUSTOMERS VALUES ( 'SPLIR','Split Rail Beer  Ale','P.O. Box 555','Lander','82520','tats-Unis','(307) 555-4680','(307) 555-6525' );


INSERT INTO CUSTOMERS VALUES ( 'SUPRD','Suprmes dlices','Boulevard Tirou, 255','Charleroi','B-6000','Belgique','(071) 23 67 22 20','(071) 23 67 22 21' );
...
INSERT INTO CUSTOMERS VALUES ( 'TOMSP','Toms Spezialitten','Luisenstr. 48','Mnster','44087','Allemagne','0251-031259','0251-035695' );

INSERT INTO CUSTOMERS VALUES ( 'TORTU','Tortuga Restaurante','Avda. Azteca 123','Mxico D.F.','05033','Mexique','(5) 555-2933','' );

INSERT INTO CUSTOMERS VALUES ( 'TRADH','Tradio Hipermercados','Av. Ins de Castro, 414','So Paulo','05634-030','Brsil','(11) 555-2167','(11) 555-2168' );
...
INSERT INTO CUSTOMERS VALUES ( 'VAFFE','Vaffeljernet','Smagslget 45','rhus','8200','Danemark','86 21 32 43','86 22 33 44' );
...
INSERT INTO CUSTOMERS VALUES ( 'WELLI','Wellington Importadora','Rua do Mercado, 12','Resende','08737-363','Brsil','(14) 555-8122','' );
...
INSERT INTO SUPPLIERS VALUES ( 2,'Nouvelle-Orlans Cajun Delights','P.O. Box 78934','Nouvelle-Orlans','70117','Etats-Unis','(100) 555-4822','' );
...
INSERT INTO SUPPLIERS VALUES ( 9,'PB Knckebrd AB','Kaloadagatan 13','Gteborg','S-345 67','Sude','031-987 65 43','031-987 65 91' );

INSERT INTO SUPPLIERS VALUES ( 10,'Refrescos Americanas LTDA','Av. das Americanas 12.890','So Paulo','5442','Brsil','(11) 555 4640','' );

INSERT INTO SUPPLIERS VALUES ( 11,'Heli Swaren GmbH  Co. KG','Tiergartenstrae 5','Berlin','10785','Allemagne','(010) 9984510','' );

INSERT INTO SUPPLIERS VALUES ( 12,'Plutzer Lebensmittelgromrkte AG','Bogenallee 51','Frankfurt','60439','Allemagne','(069) 992755','' );
...
INSERT INTO SUPPLIERS VALUES ( 15,'Norske Meierier','Hatlevegen 5','Sandvika','1320','Norvge','(0)2-953010','' );

INSERT INTO SUPPLIERS VALUES ( 16,'Bigfoot Breweries','3400 - 8th AvenueSuite 210','Bend','97101','Etats-Unis','(503) 555-9931','' );

INSERT INTO SUPPLIERS VALUES ( 17,'Svensk Sjfda AB','Brovallavgen 231','Stockholm','S-123 45','Sude','08-123 45 67','' );

INSERT INTO SUPPLIERS VALUES ( 18,'Aux joyeux ecclsiastiques','203, Rue des Francs-Bourgeois','Paris','75004','France','01.03.83.00.68','01.03.83.00.62' );
...
INSERT INTO SUPPLIERS VALUES ( 25,'Ma Maison','2960 Rue St. Laurent','Montral','H1J 1C3','Canada','(514) 555-9022','' );
...
INSERT INTO SUPPLIERS VALUES ( 28,'Gai pturage','Bat. B3, rue des Alpes','Annecy','74000','France','04.38.76.98.06','04.38.76.98.58' );

INSERT INTO SUPPLIERS VALUES ( 29,'Forts d''rables','148 rue Chasseur','Ste-Hyacinthe','J2S 7S8','Canada','(514) 555-2955','(514) 555-2921' );
...
INSERT INTO PRODUCTS VALUES (22, 'Gustaf\"s Knckebrd', 9, 5, '24 cartons (500 g)', 105.00, 104, 0, 0);
INSERT INTO PRODUCTS VALUES (23, 'Tunnbrd', 9, 5, '12 cartons (250 g)', 45.00, 61, 0, 0);
INSERT INTO PRODUCTS VALUES (25, 'NuNuCa Nu-Nougat-Creme', 11, 3, '20 jars (450 g)', 70.00, 76, 0, 0);
INSERT INTO PRODUCTS VALUES (28, 'Rssle Sauerkraut', 12, 7, '25 cans (825 g)', 228.00, 26, 0, -1);
...
INSERT INTO PRODUCTS VALUES (55, 'Pt chinois', 25, 6, '24 boxes x 2 pies', 120.00, 115, 0, 0);
...
INSERT INTO PRODUCTS VALUES (73, 'Rd Kaviar', 17, 8, '24 jars (150 g)', 75.00, 101, 0, 0);
INSERT INTO PRODUCTS VALUES (74, 'Longlife Tofu', 4, 7, '1 carton (5 kg)', 50.00, 4, 20, 0);
INSERT INTO PRODUCTS VALUES (76, 'Lakkalikri', 23, 1, '1 bottle (500 ml)', 90.00, 57, 0, 0);
INSERT INTO PRODUCTS VALUES (77, 'Original Frankfurter grne Soe', 12, 2, '12 cans', 65.00, 32, 0, 0);
